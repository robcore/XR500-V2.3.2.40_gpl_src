...
update_mark="Update"
router_ntp_setting_warning="Warning: Ther router is failed to connect to NTP server, please check your Internet connectivity or try another NTP server"
...
thank_login_info="Thank you for purchasing Netgear's XR500 Wireless-N Router. Be sure to use the Firmware Upgrade periodically to take advantage of improvements and feature additions NETGEAR offers for this product.<BR><BR>To take advantage of the Wireless-N feature offered by the router, use a wireless adapter that displays this logo."
thank_login_info_RangeMax="Thank you for purchasing Netgear's XR500 RangeMax (TM) Wireless-N 600 Router. Be sure to use the Firmware Upgrade periodically to take advantage of improvements and feature additions NETGEAR offers for this product.<BR><BR>To take advantage of the Wireless-N feature offered by the router, use a wireless adapter that displays this logo."
...
error_module="Error upgrade file module name! (Module name is \"XR500\") "
error_language_form="Incorrect upgrade file language name. (The language name is\"XR500-*-Language-table\".)"
