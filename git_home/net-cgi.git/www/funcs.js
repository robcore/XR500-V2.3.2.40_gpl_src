...
{
	var obj = parent.document.getElementById("formframe_wait_div");
	...
	if ( flag ) {
		...
		obj.style.display = "";
		if(parent.timeoutfunc)
			parent.clearTimeout(parent.timeoutfunc);
		parent.timeoutfunc=parent.setTimeout("please_wait(false);", 3000)
	} else {
		if(parent.timeoutfunc)
			parent.clearTimeout(parent.timeoutfunc);
