		      ...
		      unsigned int *timeouts)
{
	...
	if(refresh)
		...
		/*
		* NETGEAR requirements stops network monitor working as packets
		* are not accounted for. So perform accounting here without
		* performing a refresh. -@NETDUMA_Iain
		*/
